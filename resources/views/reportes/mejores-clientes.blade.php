...
@section('page_title', 'Mejores clientes')
...
<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Mejores clientes</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-900">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Compras</th>
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Total gastado</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($datos as $index => $item)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40">
                            ...
                            <td class="px-4 py-2 text-sm text-gray-500 dark:text-gray-400">{{ $item->email ?? '—' }}</td>
                            <td class="px-4 py-2 text-sm text-center font-medium text-gray-800 dark:text-gray-100">{{ $item->total_compras }}</td>
