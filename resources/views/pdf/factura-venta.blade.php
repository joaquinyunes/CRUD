...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 30px; border-bottom: 2px solid #4f46e5; padding-bottom: 15px; }
        .header-left h1 { font-size: 24px; color: #4f46e5; margin-bottom: 5px; }
        .header-right { text-align: right; }
        .header-right .numero { font-size: 18px; font-weight: bold; color: #4f46e5; }
        ...
        .totals-row.total { border-top: 2px solid #4f46e5; padding-top: 8px; margin-top: 4px; font-weight: bold; font-size: 14px; color: #4f46e5; }
...
<body>
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div style="font-size: 16px; font-weight: bold; margin: 5px 0;">{{ $venta->numero }}</div>
            <div class="fecha">Fecha: {{ $venta->fecha }}</div>
        </div>
    </div>
    ...
    <div class="footer">
        <p>{{ config('app.name') }} — Factura generada el {{ now()->format('d/m/Y H:i') }}</p>
    </div>
</body>
</html>
