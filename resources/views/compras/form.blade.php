    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <form method="POST"
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Datos de la compra</h2>

                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        <label for="proveedor_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Proveedor <span class="text-red-500">*</span></label>
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                ...
                <div class="flex justify-end mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="text-right">
                        ...
                        <span id="total-compra" class="ml-2 text-lg font-semibold text-gray-800 dark:text-gray-100">$0.00</span>
                    </div>
                </div>
