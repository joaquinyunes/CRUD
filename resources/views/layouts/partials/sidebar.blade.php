<aside class="r-sidebar">
    ...
    <nav class="r-sidebar-nav">
        <div class="r-sidebar-indicator" id="sidebarIndicator" aria-hidden="true"></div>
        ...
        @if(Auth::user()->role && Auth::user()->role->tienePermiso('productos.ver'))
        <a href="{{ route('etiquetas.index') }}" class="r-sidebar-link {{ request()->routeIs('etiquetas.*') ? 'active' : '' }}">
        ...
        @if(Auth::user()->role && Auth::user()->role->tienePermiso('pos.usar'))
        <a href="{{ route('pos.index') }}" class="r-sidebar-link {{ request()->routeIs('pos.*') ? 'active' : '' }}">
        ...
        @if(Auth::user()->role && Auth::user()->role->tienePermiso('promociones.gestionar'))
        <a href="{{ route('promociones.index') }}" class="r-sidebar-link {{ request()->routeIs('promociones.*') || request()->routeIs('listas-precio.*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"/></svg>
        ...
        <a href="{{ route('reposicion.index') }}" class="r-sidebar-link {{ request()->routeIs('reposicion.*') ? 'active' : '' }}">
        ...
        @if(Auth::user()->role && Auth::user()->role->tienePermiso('stock.ajustar'))
        <a href="{{ route('mermas.index') }}" class="r-sidebar-link {{ request()->routeIs('mermas.*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
            <span>Mermas</span>
        </a>
        <a href="{{ route('recuentos.index') }}" class="r-sidebar-link {{ request()->routeIs('recuentos.*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
            <span>Recuento de inventario</span>
        </a>
        @endif
